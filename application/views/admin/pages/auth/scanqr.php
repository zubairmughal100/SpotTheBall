...
<div class="absCenter is-Responsive">
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
    ...
    <div class="card">
    	...
    	<div class="card-body">
            <form action="<?php echo $base; ?>/admin/processTwoFactor" method="post" id="" class="needs-validation" novalidate>
                ...
                <div class="input-group mb-3">
		      	...
		      	<div class="input-group mb-3">
					...
					<input type="text" name="code" id="code" class="form-control" placeholder="Qr Code" aria-label="Username" aria-describedby="basic-addon1" required>
