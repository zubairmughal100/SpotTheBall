        ...
        <div class="col-xl-6">
          ...
          <div class="card custom-card shadow mb-4">
            <div class="card-header bg-light-blue py-3">
              <h6 class="m-0 font-weight-bold">Add Blog Page</h6>
            </div>
            <div class="card-body">
                <form action="<?php echo $base; ?>/admin/addblog" method="post" class="needs-validation" novalidate>
                  ...
                  <div class="form-group">
                      <input type="text" name="tab_name" class="form-control" placeholder="Tab name" required>
                  </div>
