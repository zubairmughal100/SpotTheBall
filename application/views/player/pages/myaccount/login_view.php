        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo $base. '/authorization/authorizelogin' ?>" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                <div class="custom">
                                    <button type="submit" name="btnSubmitLogin" id="btnSubmitLogin" class="btn btn-lg btn-block btn-custom">Login</button>
                                </div>
                            </div>
                        </form>
                        <a href="<?php echo $base; ?>/account/lostpassword">Lost your password?</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4"></div>
