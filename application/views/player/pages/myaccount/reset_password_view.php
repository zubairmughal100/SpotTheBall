        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?php echo $base. '/account/recoverpassword' ?>" class="needs-validation" novalidate>
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="basic-addon1"><span class="glyphicon glyphicon-user"></span></span>
                                    </div>
                                    <input type="text" name="secret_code" id="secret_code" class="form-control" placeholder="Account Number" aria-label="secret_code" aria-describedby="basic-addon1" required>
                            ...
                            <div class="form-group">
                                <div class="custom">
                                    <input type="submit" name="btnRecoverPasssword" id="btnRecoverPasssword" class="btn btn-lg btn-block btn-custom" value="Recover Password">
                                </div>
                            </div>
                        </form>
