...
class RowGameModel extends CI_Model {
    // Default constructor
    ...
    function getAllRowGames(){
        $users = $this->dbcommon->getAll("rowgame");
        
    }

    function getTheRowGame(){
        $sql = "SELECT * FROM rowgame WHERE id = 1 LIMIT 1";
